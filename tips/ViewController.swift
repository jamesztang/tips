...
//  tips
//
//  Created by James Tang on 9/8/15.
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if (userDefaults.objectForKey("LastSegmentIndex") != nil) {
            tipControl.selectedSegmentIndex = userDefaults.integerForKey("LastSegmentIndex")
        }
